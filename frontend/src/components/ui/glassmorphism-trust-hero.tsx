...
const PARTNERS = [
  { name: "Arbitrum", icon: Hexagon },
  { name: "Stylus", icon: Triangle },
  { name: "Solidity", icon: Command },
  { name: "Claude AI", icon: Gem },
  { name: "SEC EDGAR", icon: Shield },
  { name: "On-Chain", icon: Cpu },
];
...
export default function HeroSection({ backgroundImage }: HeroSectionProps) {
  return (
    <div className="relative w-full bg-[#09090b] text-white overflow-hidden font-sans min-h-screen">
      <style>{`
      ...
      {/* Background Image — day skyline, fades out at bottom */}
      {backgroundImage && (
        <div
      ...
      <div className="absolute inset-0 z-0 bg-gradient-to-b from-[#09090b]/40 via-[#09090b]/50 to-[#09090b]" />
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12 lg:gap-8 items-start">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center space-y-8 pt-8">
            ...
            <p className="animate-fade-in delay-300 max-w-xl text-lg text-zinc-400 leading-relaxed">
              Franchisa connects traditional corporate governance to on-chain
              tokenized voting. AI-parsed proposals, balance-weighted votes, and
              cryptographic proof.
            </p>
            ...
            <div className="animate-fade-in delay-400 flex flex-col sm:flex-row gap-4">
              <a
                href="/dashboard"
                className="group inline-flex items-center justify-center gap-2 rounded-full bg-white px-10 py-4 text-sm font-semibold text-zinc-950 transition-all hover:scale-[1.02] hover:bg-zinc-200 active:scale-[0.98] cursor-pointer"
              >
                Enter Dashboard
          ...
          <div className="lg:col-span-5 space-y-6 lg:mt-12">
            ...
            <div className="animate-fade-in delay-500">
              <BorderRotate
                ...
                borderWidth={1}
                borderRadius={24}
                className="relative overflow-hidden p-8 backdrop-blur-xl shadow-2xl"
              >
            ...
            <div className="animate-fade-in delay-500">
              <BorderRotate
                ...
                borderWidth={1}
                borderRadius={24}
                className="relative overflow-hidden py-8 backdrop-blur-xl"
              >
